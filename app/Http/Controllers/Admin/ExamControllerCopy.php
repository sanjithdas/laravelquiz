...
class ExamsControllerCopy extends Controller
{
    ...
    public function clearPastResponses(){
        $my_previous_data = Result::where('user_id',Auth::user()->id);
       $my_previous_data->delete();
