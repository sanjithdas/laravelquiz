            ...
            <table  class=" table table-bordered table-striped table-hover datatable datatable-Question">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('titles.result.incorrect_fields.choice_id') }}
                        </th>

                        <th>
                            {{ trans('titles.result.incorrect_fields.your_choice_text') }}
                        </th>
                        <th>
                            {{ trans('titles.result.incorrect_fields.correct_choice_id') }}
                        </th>

                        <th>
                            {{ trans('titles.result.incorrect_fields.correct_choice_text') }}
                        </th>
